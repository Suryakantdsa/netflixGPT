...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-full md:aspect-video md:pt-[15%] pt-[72%] px-12 md:pl-10 absolute text-gray-300 bg-gradient-to-r from-black ">
      <h1 className="lg:text-6xl md:text-4xl text-3xl font-bold md:my-6 ">
        {title}
      </h1>
      <p className="w-1/3 hidden sm:inline-block">
